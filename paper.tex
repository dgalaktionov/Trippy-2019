...
\section{Experiments}
\label{sec:exp}
In this section we discuss the practical performance of our structures. To evaluate them, we have run randomly generated queries against \acumm, \ttctr~and \ctr, with multiple configurations (TODO: describe configurations).

\subsection{Experimental dataset}
Write about the generation of Madrid dataset from real bus journeys.
...
\begin{table}
    ...
    \begin{tabular}[t]{|l|l|r|r|}
        ...
        RG32 & 13.478 & 41.09 & 96.27 \\
        RG64 & 12.79 & 38.99 & 91.36 \\
        RG128 & 12.446 & 37.94 & 88.90 \\
        \hline
    \end{tabular}
    \end{subtable}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}[t]{|l|l|r|r|}
        ...
        RG32 & 13.419 & 56.91 & 95.85 \\
        RG64 & 12.732 & 53.99 & 90.94 \\
        RG128 & 12.388 & 52.53 & 88.49 \\
        \hline
    \end{tabular}
    \end{subtable}
    \begin{subtable}[t]{.48\linewidth}
