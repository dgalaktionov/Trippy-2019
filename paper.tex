...
\begin{table}
\caption{Comparison of start\_X$_{LT}$ queries, with all variants}
\label{tab:queries}
\begin{tabular}{|r|r|r|r|r|r|}
\hline
$t_{\Psi}$ & \texttt{WMJ} & \texttt{start\_X} & \texttt{start\_X$_{L}$} & \texttt{start\_X$_{T}$} & \texttt{start\_X$_{LT}$} \\
\hline
