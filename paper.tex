...
\subsection{\ttctr}
The \ttctr was introduced in \cite{brisaboa2018new}.

Version de spire y despues la variante nueva (\ctr). \marginpar{\tiny Este ejemplo es complicado de editar, para un ejemplo sobre el nuevo ejemplo habria que hacer uno nuevo...}

\begin{figure}[tbhp]
	%\vspace{-0.2cm}
    \includegraphics[width=1.00\textwidth]{ttctr_daniil.eps}
	%\vspace{-0.3cm}
