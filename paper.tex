...
This construction allows us to answer from x to y with just CSA.

Then we can use WM forest to restrict lines.

And finally we can restrict times by finding out the right jcodes.
